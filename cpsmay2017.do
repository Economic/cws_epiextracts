*capture log close
*log using cpsmay2017.log, replace

/*------------------------------------------------
  by Jean Roth Tue Oct  9 10:58:38 EDT 2018
  Please report errors to jroth@nber.org
  NOTE:  This program is distributed under the GNU GPL. 
  See end of this file and http://www.gnu.org/licenses/ for details.
  Run with do cpsmay2017
----------------------------------------------- */
...
*local dat_name "/homes/data/cps/cpsmay2017.dat"
local dat_name "may17pub.dat"

/* The following line should contain the path to your output '.dta' file */

*local dta_name "cpsmay2017.dta"
*local dta_name "/homes/data/cps/cps`mon'`year'.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "cpsmay2017.dct"
...
note: by Jean Roth, jroth@nber.org Tue Oct  9 10:58:38 EDT 2018
...
note pes1ver: U PECERT2 = 1
note pes10tim: U PES9a = 1
note ptsxh1o: U PESXPER = 1
note pesxhry: U PESXPER = 1 OR PESXG = 1
...
label define pes1ftim
	...
	4           "Days"                                    
;
label values pes1fnum pes1fnum;
label define pes1fnum
	-1          "Not in Universe"                         
;
...
label define pes1f1l 
	...
	2           "Until you retire"                        
	3           "Until you find a different job"          
	4           "Until you finish school"                 
	5           "Until you go back to school"             
	6           "Other (not much longer, proj. is finished)"
;
...
label define pes1i   
	...
	-2          "Don't Know"                              
	-1          "Not in Universe"                         
	1           "Economic: Job is temporary"              
	2           "Business conditions"                     
	3           "Intro of new tech/modernization"         
	4           "Other economic"                          
	5           "Personal: Job performance"               
...
label define pes3l   
	...
	-2          "Don't Know"                              
	-1          "Not in universe"                         
	1           "Place where temporary help agency assigned me to"
...
label define pes3tadt
	...
	4           "Days"                                    
;
label values pes3tadn pes3tadn;
label define pes3tadn
	-1          "Not in Universe"                         
;
...
label define pes3tada
	...
	-3          "Refused"                                 
	-2          "Don't Know"                              
	-1          "Not in the Universe"                     
	1           "As long as you want"                     
	2           "Until you retire"                        
	3           "Until you find other employment"         
	4           "Until you finish school"                 
	5           "Until you go back to school"             
	6           "Other"                                   
;
...
label define prs6dicd
	...
	99          "No response"                             
;
label values pes7ccdx pes7ccdx;
...
label define pes7ccdt
	...
	4           "Days"                                    
;
label values pes7ccdn pes7ccdn;
label define pes7ccdn
	-1          "Not in Universe"                         
;
...
label define pes7ccda
	...
	6           "Other"                                   
;
label values pes7ccda pes7ccdy;
label define pes7ccdy
	-9          "No Response"                             
	-3          "Refused"                                 
	-2          "Don't Know"                              
	-1          "Not in Universe"                         
...
label define pes8icda
	...
	4           "Until you finish school"                 
	5           "Until you go back to school"             
	6           "Other (Not much longer, Rest of career, Until project"
;
...
label define pes12a  
	...
	-2          "Don't Know"                              
	-1          "Not in Universe"                         
	1           "Attending to personal or family obligations (including maintaining"
	2           "Going to school"                         
	3           "In retirement"                           
	4           "In the military"                         
	5           "Other"                                   
...
label define prs17idd
	-1          "Not in Universe"                         
	1           "Agriculture"                             
	2           "Forestry, logging, fishing, hunting, trapping"
	3           "Mining"                                  
	4           "Construction"                            
	5           "Nonmetallic mineral product manufacturing"
	6           "Primary metals and fabricated metal products"
	...
	24          "Utilities"                               
	25          "Publishing industries (except internet)" 
	26          "Motion picture, sound recording industries"
	27          "Broadcasting (except internet)"          
	28          "Internet publishing and broadcasting"    
	29          "Telecommunications"                      
	30          "Internet service provider/data processing services"
	31          "Other information services"              
	32          "Finance"                                 
	33          "Insurance"                               
	34          "Real estate"                             
...
label define pes26ip 
	...
	9           "Money is better"                         
	10          "To obtain experience/ training"          
	11          "Enjoy being own boss/independence"       
	13          "Health limitations"                      
	14          "Retired/SS earnings limit"               
	15          "Nature of work/seasonal"                 
	16          "Other personal"                          
...
label define pes36cnm
	...
	4           "Days"                                    
;
label values pes36cnum pes36cnum;
label define pes36cnum
	-9          "No Response"                             
	-3          "Refused"                                 
	-2          "Don't Know"                              
	-1          "Not in Universe"                         
...
label define pes47f  
	...
	3           "Contacted private employment agency"     
	4           "Contacted friends or relatives"          
	5           "School/university employment centers"    
	6           "Sent out resumes/filled out applications"
	7           "Checked union/professional registers"    
	8           "Placed or answered ads"                  
	9           "Other active"                            
...
label define pes47g  
	...
	1           "Contacted employer directly/interview"   
	2           "Contacted public employment agency"      
	3           "Contacted public employment agency"      
	4           "Contacted friends or relatives"          
	5           "School/university employment center"     
	6           "Sent out resumes/filled out applications"
	7           "Checked union/professional registers"    
...
label define pes47i  
	...
	5           "School/university employment center"     
	6           "Sent out resumes/filled out applications"
	7           "Checked out union/professional registers"
	8           "Placed or answered ads"                  
	9           "Other active"                            
	10          "Looked at ads"                           
	11          "Attended job training programs/courses"  
...
label define pes52a  
	...
	6           "Purchased insurance on your own (including"
	7           "Medicare"                                
	8           "Medicaid"                                
	9           "Labor union"                             
...
label define pes56l  
	...
	2           "Contract or temporary emplpyees not allowed in plan"
	3           "Haven't worked for this employer long enough to be covered"
	4           "Have pre-existing condition"             
	5           "Too expensive"                           
	6           "Other"                                   
;
...
label define prcondfa
	0           "Employed persons who do not meet criteria for 1"
	1           "Wage and salary workers who are not self-employed or independent"
;
label values prcondf2 prcondfb;
label define prcondfb
	0           "Employed individuals who do not meet the criteria for 1"
	1           "All persons who met the criterion for PRCONDF1 (except tenure"
;
label values prcondf3 prcondfc;
label define prcondfc
	0           "Employed individuals who do not meet the crierion"
	1           "Wage and salary workers whose jobs, for non"
;
label values prtmpagc prtmpagc;
label define prtmpagc
	0           "Not paid by temporary help agency"       
	1           "Persons paid by temporary help agency"   
;
label values pric     pric;   
label define pric    
	0           "Not independent contractor, independent consultant or freelancer"
	1           "Wage and salary worker and self-employed individual who works as an independent contractor, independent consultant, or freelancer"
;
label values prcntrct prcntrct;
label define prcntrct
	0           "Not working for a contract company"      
	1           "Individual works for a contract company, usually"
;
label values prcall   prcall; 
label define prcall  
	0           "Not on call or day laborers"             
	1           "Individual is either an on call worker or a day laborer."
;
label values prsio1cow prsio1cow;
label define prsio1cow
	1           "Government - Federal"                    
	2           "Government - State"                      
	3           "Government - Local"                      
	4           "Private, for profit"                     
...
label define prsuptyp
	...
	1           "Interview"                               
	2           "Noninterview"                            
	3           "Not eligible for the supplement"         
;
...
label define pesem   
	...
	2           "No"                                      
;
label values pesemwj  pesemwj;
label define pesemwj 
	-9          "No Response"                             
	-3          "Refused"                                 
	-2          "Don't Know"                              
	-1          "Not in Universe"                         
	1           "Job/Main job"                            
	2           "Second job (only display if PEMJ = 1)"   
	3           "Additional work for pay"                 
;
label values pesoem   pesoem; 
label define pesoem  
	-9          "No Response"                             
	-3          "Refused"                                 
	-2          "Don't Know"                              
	...
	2           "No"                                      
;
label values pesoemwj pesoemwj;
label define pesoemwj
	-9          "No Response"                             
	-3          "Refused"                                 
	-2          "Don't Know"                              
	-1          "Not in Universe"                         
	1           "Job/Main job"                            
	2           "Second (only display if PEMJ = 1)"       
	3           "Additional work for pay"                 
;
